...
CREATE TABLE `clientes`( 
	...
	`anio_nacimiento` VarChar( 12 ) CHARACTER SET armscii8 COLLATE armscii8_general_ci NULL DEFAULT NULL,
	`mes_nacimiento` VarChar( 6 ) CHARACTER SET armscii8 COLLATE armscii8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `clientes_perfil`( 
	...
	`token_sesion` VarChar( 150 ) CHARACTER SET armscii8 COLLATE armscii8_general_ci NULL DEFAULT NULL,
	`status` Int( 0 ) NOT NULL,
	`registro_fecha` Timestamp NOT NULL,
	`actualizacion_fecha` Timestamp NOT NULL,
...
2.- pagado',
	`status` Int( 0 ) NOT NULL,
	`registro_fecha` Timestamp NOT NULL,
	`token_referencia` VarChar( 150 ) CHARACTER SET armscii8 COLLATE armscii8_general_ci NOT NULL,
...
CREATE TABLE `tarjetas`( 
	...
	`titulo` VarChar( 100 ) CHARACTER SET armscii8 COLLATE armscii8_general_ci NOT NULL,
	`numero` Int( 0 ) NOT NULL,
	`ultimos_digitos` Int( 0 ) NOT NULL,
	`titular` VarChar( 120 ) CHARACTER SET armscii8 COLLATE armscii8_general_ci NOT NULL,
	`anio_expiracion` Year NOT NULL,
	`mes_expiracion` VarChar( 8 ) CHARACTER SET armscii8 COLLATE armscii8_general_ci NOT NULL,
	`codigo_cvv` Int( 0 ) NOT NULL,
...
-- Dump data of "cat_conceptos_gastos" ---------------------
-- ---------------------------------------------------------


-- Dump data of "cat_marcas_tarjetas" ----------------------
-- ---------------------------------------------------------
...
-- Dump data of "clientes_perfil" --------------------------
-- ---------------------------------------------------------


-- Dump data of "clientes_suscripciones" -------------------
-- ---------------------------------------------------------


-- Dump data of "clientes_tarjetas" ------------------------
-- ---------------------------------------------------------


-- Dump data of "tarjetas" ---------------------------------
-- ---------------------------------------------------------


-- Dump data of "tarjetas_gastos" --------------------------
-- ---------------------------------------------------------


-- Dump data of "tarjetas_historico" -----------------------
-- ---------------------------------------------------------
